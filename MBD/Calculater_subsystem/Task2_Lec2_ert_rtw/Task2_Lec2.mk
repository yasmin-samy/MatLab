###########################################################################
## Makefile generated for Simulink model 'Task2_Lec2'. 
## 
## Makefile     : Task2_Lec2.mk
## Generated on : Wed Apr 06 02:00:30 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Task2_Lec2.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Task2_Lec2_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Task2_Lec2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Task2_Lec2.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Task2_Lec2_ert_rtw -I$(START_DIR) -I$(START_DIR)/Calculater_subsystem -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Task2_Lec2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Task2_Lec2_ert_rtw/Task2_Lec2.c

MAIN_SRC = $(START_DIR)/Task2_Lec2_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Task2_Lec2_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
