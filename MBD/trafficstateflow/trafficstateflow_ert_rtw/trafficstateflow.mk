###########################################################################
## Makefile generated for Simulink model 'trafficstateflow'. 
## 
## Makefile     : trafficstateflow.mk
## Generated on : Wed Mar 30 16:24:14 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/trafficstateflow.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = trafficstateflow_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = trafficstateflow_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/trafficstateflow.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/trafficstateflow_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=trafficstateflow -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/trafficstateflow_ert_rtw/trafficstateflow.c

MAIN_SRC = $(START_DIR)/trafficstateflow_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/trafficstateflow_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
