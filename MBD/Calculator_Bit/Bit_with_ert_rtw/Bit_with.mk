###########################################################################
## Makefile generated for Simulink model 'Bit_with'. 
## 
## Makefile     : Bit_with.mk
## Generated on : Mon Mar 21 16:50:32 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Bit_with.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Bit_with_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Bit_with_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Bit_with.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Bit_with_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Bit_with -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Bit_with_ert_rtw/Bit_with.c

MAIN_SRC = $(START_DIR)/Bit_with_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Bit_with_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
