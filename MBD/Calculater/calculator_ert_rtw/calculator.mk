###########################################################################
## Makefile generated for Simulink model 'calculator'. 
## 
## Makefile     : calculator.mk
## Generated on : Mon Mar 21 16:57:36 2022
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = calculator_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = calculator_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/calculator.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/calculator_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=calculator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/calculator_ert_rtw/calculator.c $(START_DIR)/calculator_ert_rtw/calculator_data.c

MAIN_SRC = $(START_DIR)/calculator_ert_rtw/ert_main.c
...
OBJS = calculator.obj calculator_data.obj
...
%.obj : $(START_DIR)/calculator_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
