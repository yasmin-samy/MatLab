###########################################################################
## Makefile generated for Simulink model 'Grading_system'. 
## 
## Makefile     : Grading_system.mk
## Generated on : Mon Mar 21 17:58:46 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Grading_system.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Grading_system_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Grading_system_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Grading_system.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Grading_system_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Grading_system -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Grading_system_ert_rtw/Grading_system.c

MAIN_SRC = $(START_DIR)/Grading_system_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Grading_system_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
